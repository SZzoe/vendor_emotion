...
def add_to_manifest(repositories):
    ...
    for repository in repositories:
        ...
        project = ElementTree.Element("project", attrib = { "path": repo_target,
            "remote": repo_remote, "name": repo_full, "branch": repo_branch })
...
#    print('Looking for Emotion product dependencies')
    dependencies_path = 'vendor/emotion/dependencies/' + device + '.dependencies'
